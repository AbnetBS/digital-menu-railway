...
const STRINGS = {
  en: {
    ...
    os_phase_drinks: "Your drinks & cake are on the way ☕",
    ...
    os_barista_note:
      "{count} drinks/cake item(s) are prepared at the barista bar and arrive right away",
    ...
    os_bill_failed: "Couldn't send that just now. Please wave at a waiter.",
  ...
  am: {
    ...
    os_phase_drinks: "መጠጦችዎና ኬክዎ በመንገድ ላይ ናቸው ☕",
    ...
    os_kitchen: "ኩሽና",
    os_ready_label: "ዝግጁ",
    os_barista_note: "{count} የመጠጥ/ኬክ እቃዎች በባሪስታ ቦታ ይዘጋጃሉ፣ ወዲያውኑ ይደርሳሉ",
    os_your_items: "እቃዎችዎ",
    os_total: "ጠቅላላ",
    ...
    os_bill_failed: "አሁን መላክ አልተቻለም። እባክዎ ለሰራተኛ ይጠቁሙ።",
